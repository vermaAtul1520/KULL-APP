...
const MeetingIcon = ({size = 24, color = '#fff'}) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M12 2C13.1 2 14 2.9 14 4C14 5.1 13.1 6 12 6C10.9 6 10 5.1 10 4C10 2.9 10.9 2 12 2ZM21 9V7L15 1H5C3.89 1 3 1.89 3 3V21C3 22.11 3.89 23 5 23H11V21H5V19H13V21H19V9H21ZM13 3.5L18.5 9H13V3.5Z"
      fill={color}
    />
  </Svg>
);
...
const MeetingScreen = () => {
  ...
  const fetchMeetingDocuments = async () => {
    try {
      ...
      const url = `${BASE_URL}/api/meetings?filter=${encodeURIComponent(
        filter,
      )}`;
      ...
      Alert.alert(
        'Error',
        'Failed to load meeting documents. Please try again.',
      );
      setMeetingDocuments([]);
      setFilteredDocuments([]);
    } finally {
    ...
    <Modal
      ...
      <View style={styles.modalOverlay}>
        ...
        <View style={styles.imageModalContent}>
          <Image
            source={{uri: selectedDocument?.thumbnailUrl}}
        ...
        <View style={styles.modalFooter}>
          <Text style={styles.modalFooterText}>
            {selectedDocument?.organizer} •{' '}
            {selectedDocument &&
              formatMeetingDate(selectedDocument.meetingDate)}
          </Text>
        </View>
      </View>
    </Modal>
      ...
      <TouchableOpacity
        ...
        <View style={styles.documentHeader}>
          <View
            style={[
              ...
              {backgroundColor: getDocumentTypeColor(item.documentType)},
            ]}>
            {item.type === 'pdf' && (
          ...
          <View
            style={[styles.statusBadge, {backgroundColor: AppColors.success}]}>
        ...
        <View style={styles.documentInfo}>
          ...
          <View style={styles.documentFooter}>
            ...
            {item.fileSize && (
              <View
                style={[styles.sizeBadge, {backgroundColor: AppColors.gray}]}>
      ...
      <View style={styles.statsContainer}>
        ...
        <View style={styles.statCard}>
          <Text style={styles.statNumber}>
            {meetingDocuments.filter(d => d.documentType === 'agenda').length}
          </Text>
          <Text style={styles.statLabel}>Agendas</Text>
        </View>
        <View style={styles.statCard}>
          <Text style={styles.statNumber}>
            {meetingDocuments.filter(d => d.documentType === 'minutes').length}
          </Text>
          <Text style={styles.statLabel}>Minutes</Text>
        </View>
        <View style={styles.statCard}>
          <Text style={styles.statNumber}>
            {meetingDocuments.filter(d => d.isActive).length}
          </Text>
