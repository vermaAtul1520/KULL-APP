...
const translations = {
  ...
  hi: {
    ...
    'Your session has expired. Please log in again.':
      'आपका सत्र समाप्त हो गया है। कृपया पुनः लॉग इन करें।',
    Error: 'त्रुटि',
    ...
    // News Headlines
    'Breaking: New policy announced for social welfare':
      'ब्रेकिंग: सामाजिक कल्याण के लिए नई नीति की घोषणा',
    'Community event this weekend - register now!':
      'इस सप्ताहांत समुदायिक कार्यक्रम - अभी पंजीकरण करें!',
    'Education reforms to be implemented next month':
      'अगले महीने लागू होने वाले शिक्षा सुधार',
    'Local business owner wins national award':
      'स्थानीय व्यापारी को राष्ट्रीय पुरस्कार',
    'Health department issues new guidelines':
      'स्वास्थ्य विभाग ने जारी की नई दिशा-निर्देश',
    ...
    'Failed to update profile. Please try again.':
      'प्रोफाइल अपडेट करने में विफल। कृपया पुनः प्रयास करें।',

    // PostScreen Specific
    Posts: 'पोस्ट',
    'Loading posts...': 'पोस्ट लोड हो रहे हैं...',
    'Search posts by title, content, author...':
      'शीर्षक, सामग्री, लेखक के अनुसार पोस्ट खोजें...',
    posts: 'पोस्ट',
    post: 'पोस्ट',
    found: 'मिले',
    'filtered from': 'फ़िल्टर किया गया',
    'No posts match your search criteria':
      'आपकी खोज के मानदंडों से कोई पोस्ट मेल नहीं खाता',
    'No posts available. Create the first post!':
      'कोई पोस्ट उपलब्ध नहीं। पहला पोस्ट बनाएं!',
    'Clear Search': 'खोज साफ़ करें',
    'Failed to load posts. Please try again.':
      'पोस्ट लोड करने में विफल। कृपया पुनः प्रयास करें।',
    'Failed to like post. Please try again.':
      'पोस्ट को लाइक करने में विफल। कृपया पुनः प्रयास करें।',
    ...
    'Search news by title, content, author, category...':
      'शीर्षक, सामग्री, लेखक, श्रेणी के अनुसार समाचार खोजें...',
    articles: 'लेख',
    article: 'लेख',
    ...
    'Failed to create post. Please try again.':
      'पोस्ट बनाने में विफल। कृपया पुनः प्रयास करें।',
    ...
    Gallery: 'गैलरी',
    'Camera feature would open here. For demo, using a sample image.':
      'कैमरा फ़ीचर यहाँ खुलेगा। डेमो के लिए, नमूना चित्र का उपयोग।',
    'Gallery would open here. For demo, using a sample image.':
      'गैलरी यहाँ खुलेगी। डेमो के लिए, नमूना चित्र का उपयोग।',
    ...
    'Using default content. Please check your connection and try refreshing.':
      'डिफ़ॉल्ट सामग्री का उपयोग कर रहे हैं। कृपया अपना कनेक्शन जांचें और रीफ्रेश करने का प्रयास करें।',
    ...
    'Search bhajans by title, artist, category...':
      'शीर्षक, कलाकार, श्रेणी के अनुसार भजन खोजें...',
    'result found': 'परिणाम मिला',
    'results found': 'परिणाम मिले',
    'No results found': 'कोई परिणाम नहीं मिला',
    'Try searching with different keywords or clear the search to see all bhajans':
      'अलग शब्दों से खोजने की कोशिश करें या सभी भजन देखने के लिए खोज साफ़ करें',
    'No bhajans available': 'कोई भजन उपलब्ध नहीं',
    'Bhajan videos will appear here when available':
      'भजन वीडियो उपलब्ध होने पर यहाँ दिखाई देंगे',
    'Loading bhajans...': 'भजन लोड हो रहे हैं...',
    'Play Video': 'वीडियो चलाएं',
    'How would you like to watch this bhajan?':
      'आप इस भजन को कैसे देखना चाहेंगे?',
    'In App': 'ऐप में',
    'YouTube App': 'YouTube ऐप',
    views: 'बार देखा गया',
    'Failed to load bhajan videos. Please try again.':
      'भजन वीडियो लोड करने में विफल। कृपया पुनः प्रयास करें।',
    ...
    'Failed to load video. Please try opening in YouTube app.':
      'वीडियो लोड करने में विफल। कृपया YouTube ऐप में खोलने का प्रयास करें।',
    Category: 'श्रेणी',
  },
};
